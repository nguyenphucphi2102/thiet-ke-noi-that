        ...
        $arrows === true
          ? $options.prevArrow
            ? '<span class="' +
              ...
              '"></i></span>'
            : '<button class="slick-prev">prev</span>'
          : "",
      $nextArrow =
        $arrows === true
          ? $options.nextArrow
...
----------------------------------*/
  ...
  $("[data-countdown2]").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<div class="single-count"><span>%D</span>D</div><div class="single-count"><span>%H</span>h</div><div class="single-count"><span>%M</span>m</div><div class="single-count"><span>%S</span>s</div>',
        ),
      );
    });
  });
